  ...
  static int rgbe_error(int rgbe_error_code, const TCHAR *msg)
  {
    switch(rgbe_error_code)
    {
      case rgbe_read_error:
        nuxDebugMsg("RGBE read error");
        break;
      case rgbe_write_error:
        nuxDebugMsg("RGBE write error");
        break;
      case rgbe_format_error:
        nuxDebugMsg("RGBE bad file format: %s\n", msg);
        break;
      default:
      case rgbe_memory_error:
        nuxDebugMsg("RGBE error: %s\n", msg);
    }
...
//    {
//        //nuxAssertMsg(0, "[RGBEWriteHeader] File not found: %s", file_name);
//        return 1;
//    }
...
//    {
//        //nuxAssertMsg(0, "[RGBEWriteHeader] Can't open file: %s", filename);
//        return 1;
//    }
...
//    if (!GFileManager.FileExist(filename))
//    {
//        //nuxAssertMsg(0, "[RGBEReadHeader] File not found: %s", file_name);
//        return 1;
//    }
...
//    if (!fileStream.is_open())
//    {
//        //nuxAssertMsg(0, "[RGBEReadHeader] Can't open file: %s", filename);
//        return 1;
//    }
...
//     if (strcmp(buf,"") != 0)
//     {
//         nuxDebugMsg("missing blank line after FORMAT specifier");
//         return 1;
//     }
//
//     fileStream.getline(buf, sizeof(buf)/sizeof(buf[0]));
//     if (!fileStream.good()) {fileStream.close(); return 1;}
    ...
    {
      nuxDebugMsg("missing image size specifier");
      return 1;
    }
...
#undef MINRUNLENGTH
  ...
  int RGBEWritePixels_RLE(const TCHAR *filename, float *data, int scanline_width, int num_scanlines)
  {
    if (!GFileManager.FileExist(filename))
    {
      //nuxAssertMsg(0, "[RGBEWritePixels_RLE] File not found: %s", file_name);
      return 1;
    }
    ...
    if (!fileStream.is_open())
    {
      //nuxAssertMsg(0, "[RGBEWritePixels_RLE] Can't open file: %s", filename);
      return 1;
    }
  ...
  NBitmapData *LoadRGBE(const TCHAR *filename)
  {
    if (!GFileManager.FileExist(filename))
    {
      //nuxAssertMsg(0, "[RGBEReadPixels_RLE] File not found: %s", file_name);
      return 0;
    }
    ...
    if (!fileStream.is_open())
    {
      //nuxAssertMsg(0, "[RGBEReadPixels_RLE] Can't open file: %s", filename);
      return 0;
    }
