...
//    void DrawGrid(Graphics *g);
    ...
    */
    void PresentBufferToScreen(TRefGL<IOpenGLRectangleTexture> HWTexture, int x, int y, bool RenderToMainTexture, bool BluredBackground = false);
    ...
    */
    void CopyTextureToCompositionRT(TRefGL<IOpenGLRectangleTexture> HWTexture, int x, int y);
    ...
    {
        TRefGL<IOpenGLRectangleTexture> color_rt;
        TRefGL<IOpenGLRectangleTexture> depth_rt;
    };
    TRefGL<IOpenGLRectangleTexture> m_MainColorRT;
    TRefGL<IOpenGLRectangleTexture> m_MainDepthRT;
    TRefGL<IOpenGLRectangleTexture> m_CompositionRT;
...
//    void SetAuxDrawCallback(AuxDrawCallback f) { m_fAuxDrawCallback = f; }
    ...
    */
    ...
    void SetBackgroundPaintLayer(PaintLayer bkg);
...
private:
    ...
    */
    ...
    TRefGL<IOpenGLRectangleTexture> m_BlurTexture;
    TRefGL<IOpenGLRectangleTexture> m_FullSceneMip0;
    TRefGL<IOpenGLRectangleTexture> m_FullSceneMip1;
    TRefGL<IOpenGLRectangleTexture> m_FullSceneMip2;

    //PBuffer *m_pbuffer;
public:
    StackManagerImpl();
    StackManagerImpl(const StackManagerImpl&);
    // Does not make sense for a singleton. This is a self assignment.
    StackManagerImpl& operator=(const StackManagerImpl&);
    // Declare operator address-of as private 
    StackManagerImpl* operator &();
    ~StackManagerImpl();
