...
namespace nux
{
  ...
  WindowThread *CreateGUIThread(const char *window_title,
                                ...
                                void *data)
  {
    return CreateSingleNuxWindow(window_title, width, height, WINDOWSTYLE_NORMAL, parent, false, user_init_func, data);
  }
    ...
    void *data)
  {
    ...
    if (w == NULL)
    {
      nuxDebugMsg("[CreateThreadedNuxWindow] WindowThread creation failed.");
      return NULL;
    }
