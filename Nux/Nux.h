...
namespace nux
{
  ...
  */
  ...
  /*!
      ...
      When CreateSingleNuxWindow successfully returns, the NuxWindow internals (GraphicsDisplay, Compositor, Painter, TimerManager)
      ...
      To start the main loop of a NuxWindow created with CreateSingleNuxWindow, call NuxWindow::Run(); \n
  ...
  */
  WindowThread *CreateSingleNuxWindow(const char *window_title,
    int width,
    int height,
  ...
  /*!
      ...
      Unlike CreateSingleNuxWindow, CreateThreadedNuxWindow should always successfully return a valid NuxWindow pointer.
      ...
      @return A valid pointer to a NuxWindow if the window has been successfully created. NULL otherwise.
  */
  WindowThread *CreateThreadedNuxWindow(const char *window_title,
    int width,
    int height,
    WindowStyle window_border_style = WINDOWSTYLE_NORMAL,
    AbstractThread *parent = NULL,
