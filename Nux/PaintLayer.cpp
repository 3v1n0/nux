...
/////////////////////////////////////////////////////
  ...
  CompositionLayer::CompositionLayer (ObjectPtr <IOpenGLBaseTexture> texture0, TexCoordXForm texxform0, const Color &color0,
				      ...
				      GraphicsEngine::BlendMode blend_mode, bool write_alpha, const ROPConfig &ROP)
  {
  ...
  void CompositionLayer::Renderlayer(GraphicsEngine &graphics_engine)
  {
    ...
    {
	if (m_foreground_texture.IsValid())
	    graphics_engine.QRP_GLSL_2TexBlend(geometry_.x, geometry_.y, geometry_.GetWidth(),
	  ...
	  graphics_engine.QRP_GLSL_1TexBlendColor(geometry_.x, geometry_.y, geometry_.GetWidth(),
						  geometry_.GetHeight(), m_source_texture,
						  m_source_texture_texxform, m_source_texture_color,
      ...
      {
	if (m_foreground_texture.IsValid())
	  graphics_engine.QRP_GLSL_ColorBlend1Tex(geometry_.x, geometry_.y, geometry_.GetWidth(),
