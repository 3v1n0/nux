...
public:
    ...
    */
    virtual void EnableRowResizing(bool b){m_bEnableRowResizing = b;}
    ...
    */
    virtual void EnableColumnResizing(bool b){m_bEnableColumnResizing = b;}
    ...
    */
    void SetMouseOverColor(Color color) { m_MouseOverColor = color; }
    //! Return the user defined color used as background color when the mouse is over the item.
    /*!
        @return the user defined color used as background color when the mouse is over the item.
    */
    Color GetMouseOverColor() { return m_MouseOverColor; }
    ...
    */
    void EnableMouseOverColor(bool b) { m_IsEnableMouseOverColor = b; }
...
private:
    ...
    void UsedForComboBox(bool b) {m_IsPartOfComboBox = b;}
    bool IsPartOfCombobox() const {return m_IsPartOfComboBox;}
...
public:
    ...
    */
    const TableItem* GetRootNode() const {return m_TableItemHead;}
    /*!
        Get Root Node.
        @return TableItem* 
    */
    TableItem* GetRootNode() {return m_TableItemHead;}

    /*!
        Get number of child element of the root node.
    */
    int GetNumRootChild() const {return m_TableItemHead->NumChild();}
