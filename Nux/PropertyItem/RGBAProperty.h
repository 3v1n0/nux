...
public:
    ...
    void SetAlpha(double alpha) {m_alpha->SetValue(alpha); UpdateStartToEndColors();}

    double GetRed()     const   {return m_Red;}
    double GetGreen()   const   {return m_Green;}
    double GetBlue()    const   {return m_Blue;}
    double GetAlpha()   const   {return m_Alpha;}
    void SetColor(double red, double green, double blue, double alpha) {m_red->SetValue(red); m_green->SetValue(green); m_blue->SetValue(blue); m_alpha->SetValue(alpha); UpdateStartToEndColors();}
