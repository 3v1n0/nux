...
public:
    ...
    int GetNumColorMark() const {return (int) m_ColorMarkArray.size();}
    ColorMark GetColorMark(int i) const {return m_ColorMarkArray[i];}
...
public:
    ...
    int GetNumColorMark() const {return (int) m_ColorMarkGroup.GetNumColorMark();}
    ColorMarkGroup::ColorMark GetColorMark(int i) const {return m_ColorMarkGroup.GetColorMark(i);}
    void AddColorMark(DOUBLE x, Color color, bool selected = false);
