#ifndef TEXTENTRYIM_H
#define TEXTENTRYIM_H
...
namespace nux
{
  ...
  class TextEntryIM: public View
  {
    NUX_DECLARE_OBJECT_TYPE(TextEntryIM, View);
  public:
    TextEntryIM(const char* text, NUX_FILE_LINE_PROTO);
    ~TextEntryIM();
