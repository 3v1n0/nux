...
{
    size_t len = inl::Min(*utf16len, asciilen);
...
//
size_t copy_utf8(UTF8 *src, size_t srclen, UTF8 *dest, size_t *destlen)
{
    size_t len = inl::Min(*destlen, srclen);
    memcpy(dest, src, len * sizeof(UTF8));
