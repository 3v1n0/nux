...
//     vscrollbar->OnScrollDown.connect( sigc::mem_fun(this, &TextViewWidget::ScrollDown));
    ...
    m_TextureBuffer[0] = GetThreadGLDeviceFactory()->CreateTexture(m_ViewWidth, m_ViewHeight, 1, inl::BITFMT_R8G8B8A8);
    m_TextureBuffer[1] = GetThreadGLDeviceFactory()->CreateTexture(m_ViewWidth, m_ViewHeight, 1, inl::BITFMT_D24S8);

    m_FrameBufferObject->FormatFrameBufferObject(m_ViewWidth, m_ViewHeight, inl::BITFMT_R8G8B8A8);
...
void TextViewWidget::PreLayoutManagement()
{
    ...
    if(m_horizontal_scrollbar_enable)
    {
        ...
        hscrollbar->SetBaseX(geo.GetX() + m_border);
        hscrollbar->SetBaseY(geo.GetY() + geo.GetHeight() - hscrollbar->GetBaseHeight() - m_border);
    ...
    if(m_vertical_scrollbar_enable)
    {
        ...
        vscrollbar->SetBaseX(geo.GetX() + geo.GetWidth() - w - m_border);
        vscrollbar->SetBaseY(geo.GetY() + m_top_border);
...
long TextViewWidget::PostLayoutManagement2(long LayoutResult)
{
    ...
    if(m_vertical_scrollbar_enable)
    {
        ...
        vscrollbar->SetBaseX(geo.GetX() + geo.GetWidth() - ScrollbarWidth - m_border);
        vscrollbar->SetBaseY(geo.GetY() + m_top_border);
        vscrollbar->ComputeChildLayout();
