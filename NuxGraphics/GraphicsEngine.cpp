...
//     InitSl4TextureAdd();
    ...
    if (_normal_font == 0)
    {
      FontTexture* fnt = new FontTexture (GNuxGraphicsResources.FindResourceLocation (TEXT ("Fonts/Ubuntu_size_11.txt"), true).GetTCharPtr(), NUX_TRACKER_LOCATION);
    ...
    if (_bold_font == 0)
    {
      FontTexture* fnt = new FontTexture (GNuxGraphicsResources.FindResourceLocation (TEXT ("Fonts/Ubuntu_size_11_bold.txt"), true).GetTCharPtr(), NUX_TRACKER_LOCATION);
