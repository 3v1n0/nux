                             ...
                             unsigned int           InPrimitiveCount)
{
    ...
    {
    case PRIMITIVE_TYPE_POINTLIST:       return InPrimitiveCount;
    case PRIMITIVE_TYPE_LINELIST:        return InPrimitiveCount * 2;
    case PRIMITIVE_TYPE_LINESTRIP:       return InPrimitiveCount + 1;
