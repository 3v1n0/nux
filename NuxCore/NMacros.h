...
#define INL_DISABLE_OBJECT_COPY(Class)         \
    private:                                    \
    Class(const Class &);                       \
    const Class& operator = (const Class &);

/// GLOBAL OBJECT ///////////////////////////////////////////////////////////////////////
#define INL_GLOBAL_OBJECT_VARIABLE(Class) Class m_##Class;
#define INL_GLOBAL_OBJECT_INSTANCE(Class) Class::Instance()
#define INL_GLOBAL_OBJECT_REFERENCE(Class) Class::Instance()

#define INL_IMPLEMENT_GLOBAL_OBJECT(Class) Class* Class::pInstance =  0;
...
/*! A Global Object with a behavior similar to a singleton. Only one instance of this object can exist.
    ...
    example: 
        class GlobalObject
        {
            INL_DECLARE_GLOBAL_OBJECT(GlobalObject, , NGlobalSingletonInitializer)
...
#define INL_DECLARE_GLOBAL_OBJECT(Class, GlobalInitializer)                     \
    INL_DISABLE_OBJECT_COPY(Class);                                             \
...
#define INL_SINGLETON_CLASS_INTERNAL(ClassImpl)             \
    private:                                                \
    ClassImpl();                                            \
    ~ClassImpl();                                           \
...
#define INL_SINGLETON_CLASS_DECLARE(ClassImpl, SingletonClass) typedef ::Loki::SingletonHolder<ClassImpl, ::Loki::CreateUsingNew, ::Loki::DefaultLifetime, ::Loki::ClassLevelLockable> SingletonClass;
#define INL_SINGLETON_INSTANCE(SingletonClass) SingletonClass::Instance()
// Silence unused parameters: no warning
#define INL_UNUSED(parameter) (void)parameter;
