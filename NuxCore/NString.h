...
{
    T operator()(T value) { return ToLower(value); }
};
...
{
    T operator()(T value) { return ToUpperCase(value); }
};
...
const TCHAR* Strfind(const TCHAR* Str, const TCHAR* Find);
    ...
    inline int inlTCharStringCopy( TCHAR* Dest, t_size numberOfElements, const TCHAR* Src ) { return _tcscpy_s( Dest, numberOfElements, Src ); }
    inline int inlCharStringCopy( char* Dest, t_size numberOfElements, const char* Src ) { return strcpy_s( Dest, numberOfElements, Src ); }

	//! Append a string. Return 0 if successful.
    inline int inlTCharStringConcat( TCHAR* Dest, t_size numberOfElements, const TCHAR* Src ) { return _tcscat_s( Dest, numberOfElements, Src ); }
    inline int inlCharStringConcat( char* Dest, t_size numberOfElements, const char* Src ) { return strcat_s( Dest, numberOfElements, Src ); }
	//! Convert a string to uppercase.  Returns a pointer to the altered string. Return 0 if not successful.
	inline int inlStrupr(TCHAR* String, t_size numberOfElements) { return _tcsupr_s( String, numberOfElements ); }
#else
	//! Copy a string.
	inline TCHAR* inlStringCopy(TCHAR* Dest, t_size numberOfElements, const TCHAR* Src) { return _tcscpy( Dest, Src ); }
	//! Append a string.
	inline TCHAR* inlTCharStringConcat(TCHAR* Dest, t_size numberOfElements, const TCHAR* Src) { return _tcscat( Dest, Src ); }
	//! Convert a string to uppercase. Returns a pointer to the altered string. Return 0 if not successful.
...
inline TCHAR* Strstr( const TCHAR* String, const TCHAR* Find ) { return (TCHAR*)_tcsstr( String, Find ); }
...
inline TCHAR* Strchr( const TCHAR* String, int c ) { return (TCHAR*)_tcschr( String, c ); }
...
inline TCHAR* Strrchr( const TCHAR* String, int c ) { return (TCHAR*)_tcsrchr( String, c ); }

//! Performs a case-sensitive comparison. The return value indicates the lexicographic relation of String1 to String2.
inline int TCharStringCompare( const TCHAR* String1, const TCHAR* String2 ) { return _tcscmp( String1, String2 ); }
//! Performs a case-insensitive comparison. The return value indicates the lexicographic relation of String1 to String2.
inline int Stricmp( const TCHAR* String1, const TCHAR* String2 )  { return _tcscmp((TCHAR*)TCharToLowerCase(String1), (TCHAR*)TCharToLowerCase(String2)); }


inline int Strtoi( const TCHAR* Start, TCHAR** End, int Base ) { return _tcstoul( Start, End, Base ); }
inline int TCharStringNCompare( const TCHAR* A, const TCHAR* B, t_size Count ) { return _tcsncmp( A, B, Count ); }
inline int TCharStringNICompare( const TCHAR* A, const TCHAR* B, t_size Count ) { return _tcsncmp( (TCHAR*)TCharToLowerCase(A), (TCHAR*)TCharToLowerCase(B), Count ); }
