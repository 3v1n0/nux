...
#ifndef NFILEMANAGERPS3_H
#define NFILEMANAGERPS3_H
...
NAMESPACE_BEGIN
// File manager.
class NPS3SerialFileReader : public NSerializer
{
public:
    NPS3SerialFileReader(t_int InFileDescriptor, NOutputDevice& InError, t_int InSize);
    ~NPS3SerialFileReader();
    ...
    virtual bool Close();
    virtual void Serialize(void* V, t_u64 Length);
...
class NPS3SerialFileWriter : public NSerializer
{
public:
    NPS3SerialFileWriter(t_int InFileDescriptor, NOutputDevice& InError, t_int InPos);
    ~NPS3SerialFileWriter();
