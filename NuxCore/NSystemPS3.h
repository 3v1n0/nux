...
#define	NUX_PS3_SYS_APP_HOME	TEXT("/app_home")
// The mount point for a file system on a remote host PC
#define	NUX_PS3_SYS_HOST_ROOT	TEXT("/host_root")
// The mount point for a file system on builtin HDD
#define	NUX_PS3_SYS_DEV_HDD0	TEXT("/dev_hdd0")
#define	NUX_PS3_SYS_DEV_HDD1	TEXT("/dev_hdd1")	// system use only
// The mount point for a file system on builtin memory stick
#define	NUX_PS3_SYS_DEV_MS	    TEXT("/dev_ms")
// The mount point for a file system on builtin BDVD drive
#define NUX_PS3_SYS_DEV_BDVD    TEXT("/dev_bdvd")
// mount point used for debugging purpose such as core dump target
#define NUX_PS3_SYS_DEV_USB	    TEXT("/dev_usb")
