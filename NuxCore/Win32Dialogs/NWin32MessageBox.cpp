...
//BOOL inlWin32MessageBox(HWND OwnerWindowHandle, const TCHAR* Caption, const TCHAR* Message, MessageBoxType Type, t_u32 Modal)
{
    ...
    else
    {
        ...
        switch(Modal)
        {
        case MBMODAL_ApplicationModal:  Win32Modal = MB_APPLMODAL; break;
        case MBMODAL_SystemModal:       Win32Modal = MBMODAL_SystemModal; break;
        case MBMODAL_TaskModal:         Win32Modal = MBMODAL_TaskModal; break;
        default:                        Win32Modal = MB_APPLMODAL; break;
        }

        t_u32 Win32Icon = 0;
        switch(Icon)
        {
        case MBICON_Exclamation:    Win32Icon = MB_ICONEXCLAMATION; break;
        case MBICON_Warning:        Win32Icon = MB_ICONWARNING; break;
        case MBICON_Information:    Win32Icon = MB_ICONINFORMATION; break;
        case MBICON_Asterix:        Win32Icon = MB_ICONASTERISK; break;
        case MBICON_Question:       Win32Icon = MB_ICONQUESTION; break;
        case MBICON_Stop:           Win32Icon = MB_ICONSTOP; break;
        case MBICON_Error:          Win32Icon = MB_ICONERROR; break;
        case MBICON_Hand:           Win32Icon = MB_ICONHAND; break;
        default:                    Win32Icon = MB_ICONINFORMATION; break;
        }
