...
public:
    ...
    void SetMatrix(nux::Matrix4 matrix) {m_Matrix = matrix;}
    nux::Matrix4& GetMatrix() {return m_Matrix;}
    const nux::Matrix4& GetMatrix() const {return m_Matrix;}
...
public:
    ...
    unsigned int GetMinIndex() const {return m_MinIndex;}
    unsigned int GetMaxIndex() const {return m_MaxIndex;}
    unsigned int GetNumPolygon() const {return m_NumPolygon;}
    bool HasNormal() const {return NumNormalAttributes > 0;}
    bool HasTangent() const {return NumTangentAttributes > 0;}
    bool HasBinormal() const {return NumBinormalAttributes > 0;}
    bool HasColor() const {return NumColorAttributes > 0;}
    bool HasTexCoord() const {return NumTextureAttributes > 0;}
    bool HasTangentSpace() const {return m_hasTangentSpace;}
    ...
    GLuint GetOpenGLId(int index = 0) const {return m_OpenGLID[index];}
