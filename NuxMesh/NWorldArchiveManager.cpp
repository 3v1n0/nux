...
#define CHECK_WORLD_WRITE_ERROR /*if(m_FileStream.bad()) {m_FileStream->close(); nuxAssertMsg(0, TEXT("[CreateTextureArchiveFile] Write Error.")); return false;}*/
    ...
    m_FileStream->Serialize((char*) &ArchiveTag,            sizeof(ArchiveTag));            CHECK_WORLD_WRITE_ERROR;
    m_FileStream->Serialize((char*) &ArchiveFormatVersion,  sizeof(ArchiveFormatVersion));  CHECK_WORLD_WRITE_ERROR;

    // Date Created
    m_FileStream->Serialize((char*) &TimeStamp.m_Year,   sizeof(TimeStamp.m_Year));      CHECK_WORLD_WRITE_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Month,  sizeof(TimeStamp.m_Month));     CHECK_WORLD_WRITE_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Day,    sizeof(TimeStamp.m_Day));       CHECK_WORLD_WRITE_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Hour,   sizeof(TimeStamp.m_Hour));      CHECK_WORLD_WRITE_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Minute, sizeof(TimeStamp.m_Minute));    CHECK_WORLD_WRITE_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Second, sizeof(TimeStamp.m_Second));    CHECK_WORLD_WRITE_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_MicroSecond, sizeof(TimeStamp.m_MicroSecond));    CHECK_WORLD_WRITE_ERROR;
    ...
    m_FileStream->Serialize((char*) &m_NumberOfObjects,        sizeof(m_NumberOfObjects));           CHECK_WORLD_WRITE_ERROR;
...
#define CHECK_WORLD_READ_ERROR /*if(m_FileStream.bad()) {m_FileStream->close(); nuxAssertMsg(0, TEXT("[CreateTextureArchiveFile] Write Error.")); return false;}*/
    ...
    m_FileStream->Serialize((char*) &ArchiveTag,            sizeof(ArchiveTag));                CHECK_WORLD_READ_ERROR;
    m_FileStream->Serialize((char*) &ArchiveFormatVersion,  sizeof(ArchiveFormatVersion));      CHECK_WORLD_READ_ERROR;
    ...
    // Date Created
    m_FileStream->Serialize((char*) &TimeStamp.m_Year,   sizeof(TimeStamp.m_Year));             CHECK_WORLD_READ_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Month,  sizeof(TimeStamp.m_Month));            CHECK_WORLD_READ_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Day,    sizeof(TimeStamp.m_Day));              CHECK_WORLD_READ_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Hour,   sizeof(TimeStamp.m_Hour));             CHECK_WORLD_READ_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Minute, sizeof(TimeStamp.m_Minute));           CHECK_WORLD_READ_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_Second, sizeof(TimeStamp.m_Second));           CHECK_WORLD_READ_ERROR;
    m_FileStream->Serialize((char*) &TimeStamp.m_MicroSecond, sizeof(TimeStamp.m_MicroSecond)); CHECK_WORLD_READ_ERROR;
    ...
    // Number of Textures in the archives
    m_FileStream->Serialize((char*) &m_NumberOfObjects,        sizeof(m_NumberOfObjects));      CHECK_WORLD_READ_ERROR;
